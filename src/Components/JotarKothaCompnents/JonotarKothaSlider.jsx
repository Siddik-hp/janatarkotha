...
import JonotarKothaCard from './JonotarKothaCard';
import JonotarKothaComponentsApi from './../../Apis/JonotarKothaComponentsApi';
...
export default class JonotarKothaSlider extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <>
                <div className="mt-16 px-4  mb-4 container flex flex-row justify-between items-center">
                    <div>
                        <h1 className="lg:text-4xl text-2xl text-indigo-700">নতুন কি ?</h1>
                    </div>
                ...
                <div className=" mb-24  container pt-2 sm:mt-5 lg:mt-0 ">
                    <Slider ref={(c) => (this.slider = c)} {...settings}>
                        {JonotarKothaComponentsApi.map(
                            ({ id, title, image, link, date }) => {
                                return (
                                    <JonotarKothaCard
                                        key={id}
                                        image={image}
