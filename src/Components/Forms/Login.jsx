...
const Login = () => {
    return (
        <>
            <div>
                <div id="authentication-modal" tabindex="-1" aria-hidden="true" className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-full md:h-full ">
                    <div className="relative p-4 w-full max-w-md h-full md:h-auto mx-auto my-auto">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <form className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                                <h3 className="text-xl font-medium text-gray-900 dark:text-white">Sign in our website</h3>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="password" autoComplete='off' name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
                                </div>
